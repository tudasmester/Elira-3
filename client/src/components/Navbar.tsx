                ...
                {isAuthenticated ? (
                  <div className="flex items-center">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-72 bg-white shadow-xl border border-gray-100 rounded-2xl p-2">
                        {/* User Info Header */}
                            ...
                            <div className="relative">
                              {user?.profileImageUrl ? (
                                <img 
                                  src={user.profileImageUrl} 
                                  alt="Profile" 
                                  className="h-10 w-10 rounded-xl object-cover border-2 border-blue-100"
                                />
                              ) : (
                        ...
                        <DropdownMenuGroup className="space-y-1">
                          <DropdownMenuItem asChild>
                            <Link href="/dashboard" className="flex items-center cursor-pointer px-3 py-3 rounded-xl hover:bg-blue-50 transition-colors group">
                              ...
                              <div className="flex-1">
                                <div className="font-medium text-gray-900">Profilom</div>
                                <div className="text-xs text-gray-500">Beállítások és adatok</div>
                              </div>
                          ...
                          {isAdmin && (
                            <DropdownMenuItem asChild>
                              <Link href="/admin" className="flex items-center cursor-pointer px-3 py-3 rounded-xl hover:bg-purple-50 transition-colors group">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs text-gray-500">Tartalom kezelés</div>
                                </div>
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div className="font-medium text-red-600">Kijelentkezés</div>
                              <div className="text-xs text-red-400">Biztonságos kilépés</div>
                            </div>
                            <div className="w-1.5 h-1.5 bg-red-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
                          </DropdownMenuItem>
                        </DropdownMenuGroup>
                      </DropdownMenuContent>
                    </DropdownMenu>
